    ...
    return _then(_value.copyWith(
      ...
      userId: null == userId
          ...
          : userId // ignore: cast_nullable_to_non_nullable
              as int,
      rentHouseId: null == rentHouseId
          ? _value.rentHouseId
          : rentHouseId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$_OrderModel implements _OrderModel {
  ...
  Map<dynamic, dynamic> get car {
    if (_car is EqualUnmodifiableMapView) return _car;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_car);
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.rentHouseId, rentHouseId) ||
                other.rentHouseId == rentHouseId) &&
